...
public class GUIInfo extends JDialog{
	...
	private JPanel getJContentPane(){
		if (jContentPane == null) {
			...
			label3.setText("CHUPALETA: Sistema de gestión de kioscos");
			...
			datos.setText("Sistema para pequeños comerciantes, cuya venta de productos se realiza a clientes minoristas.\n" +
					"- Permite la facturación al cliente y a los proveedores, posibilitando el manejo de sus productos y realizando el control de stock de manera dinámica.\n" +
					"- Cuenta con la posibilidad de realizar balances de las entradas y salidas de dinero, producto de la facturación u otros gastos. \n" +
			        "- Admite gestión de usuarios con distintos permisos para administrar el sistema. El administrador tendrá acceso a todas las funcionalidades, mientras que el vendedor podrá realizar la venta al cliente y consultar sus beneficios personales.");
